...
updated: 2026-01-01
---
<section class="intro-strip"><h2 id="family">The upper-tail family</h2><p>What changes when the generator uses a power of \(-\log u\)? For \(\theta\ge1\), \(\varphi_\theta(u)=(-\log u)^\theta\) gives \[C_\theta(u,v)=\exp\{-((-\log u)^\theta+(-\log v)^\theta)^{1/\theta}\}.\] The [[Gumbel]] parameter controls the arrangement of simultaneous upper extremes.</p></section>
...
<p><strong>Source trail.</strong> Nelsen (2006), Section 4.2 and Table 4.1, printed pp. 116–119, PDF pp. 126–129 (Gumbel generator and family); Section 3.3, Definition 3.3.2 and Example 3.22, printed pp. 95–98 (extreme-value copulas); Section 5.1.1, Example 5.4(b), printed p. 164, PDF p. 173 (Kendall's tau for Gumbel). Mai and Scherer (2017), Section 1.1.3, Algorithm 1.2, printed p. 23, PDF p. 42 (conditional sampling); Section 1.2.5, Definition 1.12, printed pp. 52–53, PDF pp. 71–72 (max stability). The density and displayed conditional derivative are direct differentiations of the cited family formula.</p>
