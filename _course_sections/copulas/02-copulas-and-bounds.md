...
<div class="math-block definition"><span class="block-label">Definition 2.1 <span>Copula</span></span><p>A two-dimensional [[copula]] is a function \(C:I^2\to I\) satisfying \(C(u,0)=C(0,v)=0\), \(C(u,1)=u\), \(C(1,v)=v\), and \(C(u_2,v_2)-C(u_1,v_2)-C(u_2,v_1)+C(u_1,v_1)\ge0\) whenever \(u_1\le u_2\), \(v_1\le v_2\).</p></div>
...
<div class="math-block theorem"><span class="block-label">Theorem 2.2 <span>Copula bounds</span></span><p>Every copula satisfies</p><p>\[
...
<div class="math-block lemma"><span class="block-label">Lemma 2.3 <span>Lipschitz estimate</span></span><p>For any copula \(C\),</p><p>\[|C(u_2,v_2)-C(u_1,v_1)|\le |u_2-u_1|+|v_2-v_1|.\]</p></div>
...
<p class="source-note">Source: Roger B. Nelsen, <em>An Introduction to Copulas</em> (2006), §2.2, Definition 2.2.2 and Theorems 2.2.3–2.2.4, printed pp. 10–13 (PDF pp. 21–24), for copula conditions, Fréchet bounds, and the Lipschitz estimate; §2.1, Definition 2.1.1, printed p. 8 (PDF p. 19), for rectangle volume.</p>
