...
<p>The four observations below are an illustrative course dataset. Every calculation is small enough to check by hand. The construction follows Nelsen, Section 5.6, Definition 5.6.1, printed p. 219.</p></section>

<table><thead><tr><th>Observation</th><th>First coordinate</th><th>Second coordinate</th><th>First rank</th><th>Second rank</th></tr></thead>
<tbody><tr><td>A</td><td>2</td><td>10</td><td>1</td><td>1</td></tr><tr><td>B</td><td>5</td><td>30</td><td>2</td><td>3</td></tr><tr><td>C</td><td>8</td><td>20</td><td>3</td><td>2</td></tr><tr><td>D</td><td>11</td><td>40</td><td>4</td><td>4</td></tr></tbody></table>
...
\]</p><p>Therefore \(r=4/5\). The two statistics use different summaries of the ordering, so their numerical values can differ for the same sample. Nelsen's Theorem 5.6.2 relates both statistics to the empirical copula.</p></div>
...
<h2 id="sources">Source locations</h2>
<p>Roger B. Nelsen, <em>An Introduction to Copulas</em>, second edition, Springer, 2006: Section 5.6, Definition 5.6.1, printed p. 219 (PDF p. 228), defines the empirical copula on the grid; Theorem 5.6.2 and equations (5.6.1)-(5.6.5), printed pp. 220-221 (PDF pp. 229-230), give the sample concordance formulas and counting argument. Lemma 2.3.5, printed pp. 19-21 (PDF pp. 30-32), supplies the interpolation construction. Theorem 2.4.3, printed p. 25 (PDF p. 36), gives increasing-transformation invariance. The four observations and their numerical calculations are course illustrations of these results.</p>
